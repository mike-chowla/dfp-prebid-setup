...
class NewPrebidPartnerTests(TestCase):
  ...
  def tearDown(self):
    ...
    # https://developers.google.com/doubleclick-publishers/docs/reference/v201911/CustomTargetingService.DeleteCustomTargetingKeys
    # https://developers.google.com/doubleclick-publishers/docs/reference/v201911/CustomTargetingService.DeleteCustomTargetingValues
