...
def convert_to_min_price(order_name):
  ...
  for li in line_items:
      ...
      if 'name' in li:
          ...
          # Only act on average line items -- which all end with a 5
          if re_ends_5.search(name):
              ...
              if m:
                  ...
                  new_name = "{0}_{1}".format(m[1],cpm_mod)

                  if 'costPerUnit' in li and 'valueCostPerUnit' in li:
                      print ("Orig: {0} {1} {2} {3}".format(name, cpm, li['costPerUnit']['microAmount'], li['valueCostPerUnit']['microAmount']))
                      li['name'] = new_name
                      li['costPerUnit']['microAmount'] = cpm_mod_micro
                      li['valueCostPerUnit']['microAmount'] = cpm_mod_micro
                      print (" New: {0} {1} {2} {3}".format(new_name, cpm_mod, li['costPerUnit']['microAmount'], li['valueCostPerUnit']['microAmount']))
                      print("")
                      updated = True
