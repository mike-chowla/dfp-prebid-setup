...
def change_placements(order_name):
  """
  ...
  for li in line_items:
      ...
      if 'disableSameAdvertiserCompetitiveExclusion' in li:
              li['disableSameAdvertiserCompetitiveExclusion'] = True
              updated = True
...
def main():
  ...
  logger.info(
    ...
    Going to Set disableSameAdvertiserCompetitiveExclusion
